classdef MixFiltrSig_01 < matlab.System 
...
%             obj.myFront.i_nCount_tic_null=70;
        ...
        function [y, iX0, iX1, iX2] = stepImpl(obj,u)
            y = 0;
            e=99999999;
            e
            iX0 = obj.ind.i; 
            ...
            if obj.ind.i < obj.M1count
                obj.ind.i=obj.ind.i + 1;
                iX0=obj.ind.i;
                
%                d=find(obj.M1>obj.u_sig_k, 1);
                obj.u_sig_k = obj.M1(max(min(obj.ind.i, obj.M1count),1),1);                
                obj.u_sig_k
               iX1 =  obj.u_sig_k; 
...
%{            
        формируем EMA 
            obj.alfa_ema=2/(obj.nEma+1);
            obj.alfa_ema1 = 1-obj.alfa_ema;
            y = obj.y_old*obj.alfa_ema1 + obj.alfa_ema*(u);
%}
            obj.y_old = y;
        end
