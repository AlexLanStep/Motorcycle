...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Moment_work_2017.exe
...
MODELREF_LINK_RSPFILE_NAME = Moment_work_2017_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Moment_work_2017_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Moment_work_2017.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Moment_work_2017_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
SRCS = $(START_DIR)/Moment_work_2017_grt_rtw/Moment_work_2017.c $(START_DIR)/Moment_work_2017_grt_rtw/Moment_work_2017_data.c $(START_DIR)/Moment_work_2017_grt_rtw/rtGetInf.c $(START_DIR)/Moment_work_2017_grt_rtw/rtGetNaN.c $(START_DIR)/Moment_work_2017_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = Moment_work_2017.obj Moment_work_2017_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/Moment_work_2017_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Moment_work_2017_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
