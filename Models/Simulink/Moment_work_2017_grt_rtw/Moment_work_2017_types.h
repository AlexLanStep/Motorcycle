...
#ifndef typedef_emxArray__common_Moment_work__T
#define typedef_emxArray__common_Moment_work__T

typedef struct emxArray__common emxArray__common_Moment_work__T;

#endif                                 /*typedef_emxArray__common_Moment_work__T*/
...
#ifndef typedef_emxArray_real_T_Moment_work_2_T
#define typedef_emxArray_real_T_Moment_work_2_T

typedef struct emxArray_real_T emxArray_real_T_Moment_work_2_T;

#endif                                 /*typedef_emxArray_real_T_Moment_work_2_T*/
...
typedef struct {
  ...
  real_T nm;
  real_T m[200];
  emxArray_real_T_Moment_work_2_T *x0;
  real_T xsum;
  real_T x2sum;
  real_T x_sr;
  emxArray_real_T_Moment_work_2_T *x_0;
  real_T x_01;
  real_T x_001;
  real_T xsum2;
  real_T z0;
