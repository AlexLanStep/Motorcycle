###########################################################################
## Makefile generated for Simulink model 'MixailFiltr_02m'. 
## 
## Makefile     : MixailFiltr_02m.mk
## Generated on : Tue Jan 25 15:03:58 2022
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MixailFiltr_02m.exe
...
MODELREF_LINK_RSPFILE_NAME = MixailFiltr_02m_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = MixailFiltr_02m_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MixailFiltr_02m.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/MixailFiltr_02m_grt_rtw -IE:/Motorcycle/Models/Simulink -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=MixailFiltr_02m -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/MixailFiltr_02m_grt_rtw/MixailFiltr_02m.c $(START_DIR)/MixailFiltr_02m_grt_rtw/rtGetInf.c $(START_DIR)/MixailFiltr_02m_grt_rtw/rtGetNaN.c $(START_DIR)/MixailFiltr_02m_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = MixailFiltr_02m.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/MixailFiltr_02m_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MixailFiltr_02m_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
