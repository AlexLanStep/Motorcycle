...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MixailFiltr.exe
...
MODELREF_LINK_RSPFILE_NAME = MixailFiltr_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = MixailFiltr_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MixailFiltr.exe
...
DEFINES_STANDARD = -DMODEL=MixailFiltr -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
%.obj : $(START_DIR)/MixailFiltr_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MixailFiltr_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
